...
<body>
    ...
    <!-- Side Menu -->
    <!--<div class="lang-group">hu | <a href="en/">en</a> </div>-->
    <a id="menu-toggle" href="#" class="btn btn-primary btn-lg toggle"><i class="fa fa-bars"></i></a>
    <div id="sidebar-wrapper">
        <ul class="sidebar-nav">
            <a id="menu-close" href="#" class="btn btn-default btn-lg pull-right toggle"><i class="fa fa-times"></i></a>
            <li class="sidebar-brand"><a href="http://kmonitor.hu/">K-Monitor</a>
            </li>
            ...
            <li><a href="http://k-monitor.hu/" target="_blank">Kapcsolat</a>
            </li>
        </ul>
    </div>
    <!-- /Side Menu -->
		...
		<div class="vert-text">
            ...
            <p class="lead">
                ...
                <div style="padding-bottom:3em">
				   ...
				   <!-- <div class=""><iframe src="//www.facebook.com/plugins/like.php?href=https%3A%2F%2Fwww.facebook.com%2FKmonitor&amp;width=100&amp;layout=box_count&amp;action=like&amp;show_faces=false&amp;share=false&amp;height=65&amp;appId=469801333121609" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:65px;" allowTransparency="true"></iframe><a href="https://twitter.com/share" class="twitter-share-button" data-url="http://voksmonitor.hu" data-text="Voksmonitor.hu" data-hashtags="EP2014" data-count ="vertical">Tweet</a>
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+'://platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document, 'script', 'twitter-wjs');</script>
<div class="g-plusone" data-size="tall" data-href="http://voksmonitor.hu/"></div>
